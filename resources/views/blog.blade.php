                        ...
                        <div class="wdm_hx_services_wrap">
                            <div class="container">
                                <div class="wdm_hx_title_holder">
                                    <h3>BLOG</h3>
                                    <span>Some of my pieces..</span>
                                </div>
              
                                      @foreach($blog as $blogs)
                                      <div class="columns_new">
                                        <ul class="price_new">
                                          <img class="img-responsive" src="{{$blogs->blog_image}}"/>
                                          <li class="grey">{{$blogs->blog_title}}
</li>
                                          <li><p class="justify-blog">{{$blogs->blog_descr}}</p></li>
                                         
                                          <li class="grey"><a href="{{$blogs->blog_link}}" class="button_new">Read More..</a></li>
                                        </ul>
                                      </div>
                                      @endforeach
