                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>                    <form class="aboutbody"method="post" role="form" enctype="multipart/form-data">
                                            ...
                                            <img src="../img/{{$projects->project_image}}" width="100px" height="100px">
                                            </td>
                                            <td><input class="inputstyle" type="textarea" name="project_descr" value="{{$projects->project_descr}}"></td>

                                        	<td>                                            {{csrf_field()}}
<button type="submit" name="up" value="{{$projects->project_id}}">UPDATE</button></td>
    </form></tr>
